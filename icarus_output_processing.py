...
def main():
    ...
    print_cache_hit_rates(file_prefix, '.spickle', goal_tuple=('CACHE_HIT_RATIO', 'MEAN'), plot=False)
    print 'normalized reward'
    print_cache_hit_rates(file_prefix, '.spickle', goal_tuple=('CACHE_HIT_RATIO', 'WEIGHTED_CACHE_HIT_RATIO'), plot=False)
    print 'weighted average hit rate'
    print_cache_hit_rates(file_prefix, '.spickle', goal_tuple=('CACHE_HIT_RATIO', 'WEIGHTED_CACHE_HIT_RATIO_SUM'), plot=False)
    print 'weight-frequency hit rate'
    print_cache_hit_rates(file_prefix, '.spickle', goal_tuple=('CACHE_HIT_RATIO', 'AVERAGE_BENEFIT'), plot=False)
